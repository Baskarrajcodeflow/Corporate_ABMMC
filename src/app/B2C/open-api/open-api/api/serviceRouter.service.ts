...
export class ServiceRouterService {
    ...
    public healthCheck(observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: '*/*', context?: HttpContext, transferCache?: boolean}): Observable<any> {
        ...
        let localVarPath = `/tms/api/tms/router/health`;
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public route(serviceTransactionRecord: ServiceTransactionRecord, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: '*/*', context?: HttpContext, transferCache?: boolean}): Observable<BaseResponseString>;
    public route(serviceTransactionRecord: ServiceTransactionRecord, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: '*/*', context?: HttpContext, transferCache?: boolean}): Observable<HttpResponse<BaseResponseString>>;
    public route(serviceTransactionRecord: ServiceTransactionRecord, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: '*/*', context?: HttpContext, transferCache?: boolean}): Observable<HttpEvent<BaseResponseString>>;
    public route(serviceTransactionRecord: ServiceTransactionRecord, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: '*/*', context?: HttpContext, transferCache?: boolean}): Observable<any> {
        if (serviceTransactionRecord === null || serviceTransactionRecord === undefined) {
            throw new Error('Required parameter serviceTransactionRecord was null or undefined when calling route.');
        }
        ...
        let localVarPath = `/tms/api/tms/router/basic`;
